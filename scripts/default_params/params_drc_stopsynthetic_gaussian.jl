...
ado_vel_dict = Dict("PEDESTRIAN/1" => [MvNormal([0.0, 1.0], Diagonal([0.1, 0.15])), MvNormal([0.0, 0.0], Diagonal([0.15, 0.15]))],
                    ...
                    "PEDESTRIAN/7" => [MvNormal([0.0, 1.0], Diagonal([0.1, 0.15])), MvNormal([0.0, 0.0], Diagonal([0.15, 0.15]))],
                    "PEDESTRIAN/8" => [MvNormal([0.0, -1.0], Diagonal([0.1, 0.15])), MvNormal([0.0, 0.0], Diagonal([0.15, 0.15]))],
